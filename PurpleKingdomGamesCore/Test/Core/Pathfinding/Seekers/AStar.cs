    ...
    internal class AStarTest
    {
        ...
        public void TestSeekMedium()
        {
            ...
            Point2D[] expectedPath = new Point2D[] {
                ...
                new Point2D(80, 17), new Point2D(79, 17), new Point2D(78, 18),
                new Point2D(77, 18), new Point2D(76, 19), new Point2D(75, 19),
                new Point2D(74, 19), new Point2D(73, 19), new Point2D(72, 19),
                new Point2D(71, 19), new Point2D(70, 20), new Point2D(69, 20),
                ...
                new Point2D(35, 19), new Point2D(34, 19), new Point2D(33, 20),
                ...
                new Point2D(31, 35), new Point2D(32, 36), new Point2D(33, 37),
                new Point2D(34, 37), new Point2D(35, 37), new Point2D(36, 38),
                new Point2D(37, 38), new Point2D(38, 38), new Point2D(39, 38),
                new Point2D(40, 38), new Point2D(41, 38), new Point2D(42, 38),
                new Point2D(43, 38), new Point2D(44, 37), new Point2D(45, 37),
                new Point2D(46, 37), new Point2D(47, 37), new Point2D(48, 37),
                new Point2D(49, 37), new Point2D(50, 37), new Point2D(51, 37),
